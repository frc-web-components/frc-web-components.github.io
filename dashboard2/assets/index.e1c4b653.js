var e,t,i,s,r,n,o,a,l,d,h,c,u,p,m,b,g,y,f,v,w,x,S=Object.defineProperty,$=Object.defineProperties,E=Object.getOwnPropertyDescriptors,_=Object.getOwnPropertySymbols,k=Object.prototype.hasOwnProperty,C=Object.prototype.propertyIsEnumerable,T=(e,t,i)=>t in e?S(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i,M=(e,t)=>{for(var i in t||(t={}))k.call(t,i)&&T(e,i,t[i]);if(_)for(var i of _(t))C.call(t,i)&&T(e,i,t[i]);return e},N=(e,t)=>$(e,E(t)),V=(e,t,i)=>(T(e,"symbol"!=typeof t?t+"":t,i),i),I=(e,t,i)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,i)},R=(e,t,i)=>(((e,t,i)=>{if(!t.has(e))throw TypeError("Cannot "+i)})(e,t,"access private method"),i);import{I as L,_ as B,a as A,s as P,r as z,$ as D,b as O,W as U,y as j,c as F,i as q,d as H,C as W,e as K,S as G,f as Q,x as X}from"./vendor.810c0b74.js";L.addIcon("mdi:move-resize-variant",B),L.addIcon("mdi:heart",A);class J extends HTMLElement{get value(){return this.editor&&this.editor.getValue()||this.textContent}set value(e){this.editor?this.editor.setValue(e):this.textContent=e}static get observedAttributes(){return["theme","mode","fontsize","softtabs","tabsize","readonly","wrapmode"]}constructor(e){var t;return(t=(e=super(e)).attachShadow&&e.getRootNode?e.attachShadow({mode:"open"}):e.createShadowRoot()).innerHTML='\n  <style>\n      :host{\n          display: flex;\n          min-height: 1em;\n          flex-direction: column;\n      }\n      #juicy-ace-editor-container{\n          flex: 1;\n          height: 100%;\n      }\n  </style>\n  <div id="juicy-ace-editor-container"></div>\n',e.container=t.querySelector("#juicy-ace-editor-container"),e}connectedCallback(){var e,t=this.childNodes[0],i=this.container,s=this;this.editor?e=this.editor:(i.textContent=this.value,e=ace.edit(i),this.dispatchEvent(new CustomEvent("editor-ready",{bubbles:!0,composed:!0,detail:e})),this.editor=e,this.injectTheme("#ace_editor\\.css"),this.injectTheme("#ace-tm"),this.injectTheme("#ace_searchbox"),e.getSession().on("change",(function(e){s.dispatchEvent(new CustomEvent("change",{bubbles:!0,composed:!0,detail:e}))}))),e.renderer.addEventListener("themeLoaded",this.onThemeLoaded.bind(this)),e.setTheme(this.getAttribute("theme")),e.setFontSize(parseInt(this.getAttribute("fontsize"))||12),e.setReadOnly(this.hasAttribute("readonly"));var r=e.getSession();r.setMode(this.getAttribute("mode")),r.setUseSoftTabs(this.getAttribute("softtabs")),this.getAttribute("tabsize")&&r.setTabSize(this.getAttribute("tabsize")),r.setUseWrapMode(this.hasAttribute("wrapmode"));var n=new MutationObserver((function(e){e.forEach((function(e){"characterData"==e.type&&(s.value=t.data)}))}));t&&n.observe(t,{characterData:!0}),this._attached=!0}disconnectedCallback(){this._attached=!1}attributeChangedCallback(e,t,i){if(!this._attached)return!1;switch(e){case"theme":this.editor.setTheme(i);break;case"mode":this.editor.getSession().setMode(i);break;case"fontsize":this.editor.setFontSize(i);break;case"softtabs":this.editor.getSession().setUseSoftTabs(i);break;case"tabsize":this.editor.getSession().setTabSize(i);break;case"readonly":this.editor.setReadOnly(""===i||i);break;case"wrapmode":this.editor.getSession().setUseWrapMode(null!==i)}}onThemeLoaded(e){var t="#"+e.theme.cssClass;this.injectTheme(t),this.container.style.display="none",this.container.offsetHeight,this.container.style.display=""}injectTheme(e){var t,i,s=document.querySelector(e);this.shadowRoot.appendChild((t=s,(i=document.createElement("style")).id=t.id,i.textContent=t.textContent,i))}}window.customElements.define("juicy-ace-editor",J);const Y={properties:{value:{type:Number},min:{type:Number,defaultValue:-1},max:{type:Number,defaultValue:1},center:{type:Number}}};function Z(e,t,i){return Math.min(i,Math.max(e,t))}class ee extends P{constructor(){super(),this.value=0,this.min=-1,this.max=1,this.center=0,this.dragging=!1}get min(){return Math.min(this._min,this._max)}set min(e){const t=this._min;this._min=e,this.requestUpdate("min",t)}get max(){return Math.max(this._min,this._max)}set max(e){const t=this._max;this._max=e,this.requestUpdate("max",t)}updateForeground(){const{min:e,max:t,center:i,value:s}=this,r=Z(s,e,t),n=this.shadowRoot.querySelector("[part=foreground]");t<i?(n.style.setProperty("--foreground-width",Math.abs(r-t)/(t-e)*100+"%"),n.style.setProperty("--foreground-left","auto"),n.style.setProperty("--foreground-right","0")):e>i?(n.style.setProperty("--foreground-width",Math.abs(r-e)/(t-e)*100+"%"),n.style.setProperty("--foreground-left","0"),n.style.setProperty("--foreground-right","auto")):r>i?(n.style.setProperty("--foreground-width",Math.abs(r-i)/(t-e)*100+"%"),n.style.setProperty("--foreground-left",Math.abs(e-i)/(t-e)*100+"%"),n.style.setProperty("--foreground-right","auto")):(n.style.setProperty("--foreground-width",Math.abs(r-i)/(t-e)*100+"%"),n.style.setProperty("--foreground-left","auto"),n.style.setProperty("--foreground-right",Math.abs(t-i)/(t-e)*100+"%"))}resized(){this.updateForeground()}updated(){this.updateForeground()}setDragPosition(e){const{left:t,width:i}=this.getBoundingClientRect(),s=Z((e.clientX-t)/i,0,1),r=this.min+(this.max-this.min)*s,n=new CustomEvent("barDrag",{bubbles:!0,composed:!0,detail:{value:r}});this.dispatchEvent(n)}firstUpdated(){this.setAttribute("draggable","false"),window.addEventListener("mousemove",(e=>{this.dragging&&this.setDragPosition(e)})),window.addEventListener("mouseup",(e=>{this.dragging=!1}))}onMouseDown(e){this.dragging=!0,this.setDragPosition(e)}render(){return D`
        ...
        ></div>
    `}}V(ee,"properties",Y.properties),V(ee,"styles",z`
    :host {
  ...
  `),customElements.define("frc-line-chart",ge);const ye=[ae,he,Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-line-chart",elementConfig:be})],fe=z`
  :host {
    display: inline-block;
    width: auto;
    height: auto;
...
`,ve={properties:{name:{type:String,defaultValue:"Command"},running:{type:Boolean},controllable:{type:Boolean},isParented:{type:Boolean,attribute:"is-parented"},label:{type:String}}};class we extends U{onClick(){this.controllable&&(this.running=!this.running)}render(){return D`
      <vaadin-button theme="${1==this.running?"primary":""} contrast" part="button" @click="${this.onClick}">
        ${this.label||this.name}
      </vaadin-button>
    `}}V(we,"properties",ve.properties),V(we,"styles",[fe,z`
      :host {
        height: 50px;
      }
    ...
    `]),customElements.define("frc-robot-command",we);var xe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-robot-command",elementConfig:ve});const Se={properties:{default:{type:String},command:{type:String},hasCommand:{type:Boolean,attribute:"has-command"},hasDefault:{type:Boolean,attribute:"has-default"},label:{type:String},name:{type:String},hideName:{type:Boolean,attribute:"hide-name"}}};class $e extends U{renderValue(e,t){return t?D`<span class="has-value">${e}</span>`:D`<span class="no-value">None</span>`}render(){return D`
      ${this.hideName?"":D`
    ...
    `}}V($e,"properties",Se.properties),V($e,"styles",z`
    :host {
      display: inline-block;
  ...
  `),customElements.define("frc-robot-subsystem",$e);const Ee=[xe,Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-robot-subsystem",elementConfig:Se})];class _e{constructor(e,t){this.svg=e,this.angle=null,this.setAngle(t),this.animationStartAngle=t,this.animationEndAngle=t,this.animationStartTime=0,this.animationTime=0,this.duration=1;const i=()=>{this.duration>this.animationTime&&(this.animationTime=Math.min((Date.now()-this.animationStartTime)/1e3,this.duration));const e=(e=>e*(2-e))(this.animationTime/this.duration);this.setAngle(this.animationStartAngle+e*(this.animationEndAngle-this.animationStartAngle)),window.requestAnimationFrame(i)};window.requestAnimationFrame(i)}animate(e){this.animationStartTime=Date.now(),this.animationTime=0,this.animationStartAngle=this.angle,this.animationEndAngle=e}setAngle(e){this.angle=e,this.svg.style.setProperty("--deg",`${e}deg`)}setDuration(e){this.duration=e}}const ke={properties:{currentColor:{type:String,attribute:"current-color",primary:!0,inputType:"StringDropdown",allowCustomValues:!1,getOptions:()=>["","red","yellow","blue","green"]},desiredColor:{type:String,attribute:"desired-color",inputType:"StringDropdown",allowCustomValues:!1,getOptions:()=>["","red","yellow","blue","green"]},clockwise:{type:Boolean},duration:{type:Number,defaultValue:1}}};class Ce extends P{constructor(){super(),this.colors=["red","yellow","blue","green","red","yellow","blue","green"],this.positionIndex=3,this.animator=null,this.currentColor="",this.desiredColor="",this.clockwise=!1,this.duration=1}getRotation(){return 25-45*(this.positionIndex-3)}setPositionIndex(){const e=this.positionIndex%8;for(let t=1;t<4;t++){const i=(e+(this.clockwise?-t:t))%8;if(this.colors[i>=0?i:i+8]===this.currentColor){this.positionIndex=this.positionIndex+(this.clockwise?-t:t),this.animator.animate(this.getRotation());break}}}getCoordinatesForPercent(e){return[Math.cos(2*Math.PI*e),Math.sin(2*Math.PI*e)]}getPath(e){const[t,i]=this.getCoordinatesForPercent(.125*e),[s,r]=this.getCoordinatesForPercent(.125*(e+1));return[`M ${t} ${i}`,`A 1 1 0 0 1 ${s} ${r}`,"L 0 0"].join(" ")}updated(e){e.has("currentColor")&&this.colors.indexOf(this.currentColor)>=0&&this.setPositionIndex(),e.has("duration")&&this.animator.setDuration(Math.max(0,this.duration))}firstUpdated(){this.svg=this.shadowRoot.querySelector("svg"),this.animator=new _e(this.shadowRoot.querySelector("svg"),this.getRotation())}setDesiredColor(e){this.desiredColor=e}resized(){const{height:e}=this.getBoundingClientRect();this.style.setProperty("--control-panel-height",`${e}px`),this.requestUpdate()}render(){return D`
    ...
    `}}V(Ce,"properties",ke.properties),V(Ce,"styles",z`
    :host {
      display: inline-flex;
      width: 300px;
      align-items: center;
  ...
  `),customElements.define("frc-control-panel",Ce);var Te=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-control-panel",elementConfig:ke});function Me(e){return 180*e/Math.PI}function Ne(e,t,i){return`<polygon \n            points="${e.x},${e.y} ${t.x},${t.y} ${i.x},${i.y}" />`}function Ve(e,t,i,s,r){return`<path d="${function(e,t,i,s,r){var n=Ie(e,t,i,r),o=Ie(e,t,i,s),a=r-s<=180?"0":"1",l=r>s?1:0;return["M",n.x,n.y,"A",i,i,0,a,l,o.x,o.y].join(" ")}(e,t,i,s,r)}"/>`}function Ie(e,t,i,s){var r=s*Math.PI/180;return{x:e+i*Math.cos(r),y:t-i*Math.sin(r)}}function Re(e,t,i,s){return function(e,t,i,s){return`<line x1="${e}" y1="${t}" x2="${i}" y2="${s}" />`}(i,0,Math.cos(t)*e+i,Math.sin(t)*e)+function(e,t,i,s){const r=t/2,n=Math.cos(e),o=Math.sin(e);let a=Math.cos(e+Math.PI/2)*r,l=Math.sin(e+Math.PI/2)*r;return Ne({x:n*s-a+i,y:o*s-l},{x:n*s+a+i,y:o*s+l},{x:n*(t+s)+i,y:o*(t+s)})}(t,s,i,e)}function Le(e,t,i,s,r){if(t<0)throw new Error("Radius cannot be negative. Given: "+t);if(r<0)throw new Error("The size of the arrowhead cannot be negative. Given: "+r);return t===1/0?Re(i,e,s,r):function(e,t,i,s){const r=Me(i/t);return Ve(s,0,t,Me(e),Me(e)-r)}(e,t,i,s)+function(e,t,i,s,r){const n=t/2,o=r/i-e,a=Math.sqrt(t*t+i*i),l=(r+t*Math.sign(r))/i-e,d=Math.cos(o),h=Math.sin(o),c={x:(i+n)*d+s,y:(i+n)*h},u={x:(i-n)*d+s,y:(i-n)*h},p={x:a*Math.cos(l)+s,y:a*Math.sin(l)};return Ne(c,p,u)}(e,r,t,s,i)}function Be(e,t,i,s,r){return Le(e,t,t*i,s,r)}function Ae(e,t,i){return Math.min(i,Math.max(e,t))}const Pe={properties:{leftMotorSpeed:{type:Number,attribute:"left-motor-speed"},rightMotorSpeed:{type:Number,attribute:"right-motor-speed"}}};class ze extends P{get clampedLeftMotorSpeed(){return Ae(this.leftMotorSpeed,-1,1)}get clampedRightMotorSpeed(){return Ae(this.rightMotorSpeed,-1,1)}constructor(){super(),this.leftMotorSpeed=0,this.rightMotorSpeed=0;new ResizeObserver((()=>{this.resized()})).observe(this)}drawMotionVector(e,t){const i=this.shadowRoot.getElementById("svg").getBoundingClientRect(),s=.13*i.width,r=i.width-2*(s+20),n=i.height-40;if(Math.abs(e)<=.05&&Math.abs(t)<=.05)return function(e){const t=e/2;return`<g class="x">\n    <line \n      x1="${-t}"\n      y1="${-t}"\n      x2="${t}"\n      y2="${t}"\n    />\n   \n    <line \n      x1="${-t}"\n      y1="${t}"\n      x2="${t}"\n      y2="${-t}"\n    />\n  </g>`}(.2*i.width);const o=Math.min(r,n)/2-8;if(Math.abs(e-t)<=.001){return`<g class="arrow">${Re(Math.abs(e*o),-Math.sign(e)*Math.PI/2,0,8)}</g>`}const a=Math.PI,l=(t-e)/2,d=(e+t)/2,h=d/l;let c;if(Math.abs(h)>=1){const e=-Math.sign(h),t=(e+1)*a/2;let i=Math.abs(h*o);c=Le(t,i,e*d*o,e*i,8)}else{const i=Math.sign(e-t);if(0==h){c=Be(l<0?a:0,Math.max(e,t)*o,i*a,0,8)}else{let s=h<0?e:t,r=h<0?t:e,n=Math.abs(s)*o;c=Be(h<0?a:0,n,i*((r/s-(u=0))*(a-(p=.5))/(-1-u)+p),-h*n,8)}}var u,p;return`<g class="arrow">${c}</g>`}drawDrivetrain(){const e=this.shadowRoot.getElementById("svg").getBoundingClientRect(),t=.13*e.width,i=Math.min(.13*e.width,.15*e.height),s=20;return`\n      <rect \n        width="calc(100% - ${2*(t+s)}px)" \n        height="calc(100% - 40px)"\n        x="${t+s}" \n        y="20px" \n      />\n    `+`\n      <rect \n        width="${t}px" \n        height="${2*i}" \n        x="20px" \n        y="20px" \n      />\n    `+`\n      <rect \n        width="${t}px" \n        height="${2*i}" \n        x="calc(100% - ${t+s}px)" \n        y="20px" \n      />\n    `+`\n      <rect \n        width="${t}px" \n        height="${2*i}" \n        x="20px"\n        y="calc(100% - ${2*i+20}px)"\n      />\n    `+`\n      <rect \n        width="${t}px" \n        height="${2*i}" \n        x="calc(100% - ${t+s}px)" \n        y="calc(100% - ${2*i+20}px)"\n      />\n    `}getLeftForegroundStyle(){return this.getForegroundStyle(this.clampedLeftMotorSpeed)}getRightForegroundStyle(){return this.getForegroundStyle(this.clampedRightMotorSpeed)}getForegroundStyle(e){const t=Ae(e,-1,1);return t>0?`\n        height: ${Math.abs(t)/2*100}%;\n        top: auto;\n        bottom: 50%;\n      `:`\n        height: ${Math.abs(t)/2*100}%;\n        top: 50%;\n        bottom: auto;\n      `}firstUpdated(){let e=this.drawMotionVector(0,0);this.shadowRoot.getElementById("drivetrain").innerHTML=this.drawDrivetrain(),this.shadowRoot.getElementById("forceVector").innerHTML=e}resized(){let e=this.drawMotionVector(this.clampedLeftMotorSpeed,this.clampedRightMotorSpeed);this.shadowRoot.getElementById("forceVector").innerHTML=e;const t=this.shadowRoot.getElementById("svg").getBoundingClientRect();this.shadowRoot.getElementById("forceVector").style.transform=`translate(${.5*t.width}px, ${.5*t.height}px)`,this.shadowRoot.getElementById("drivetrain").innerHTML=this.drawDrivetrain()}updated(){let e=this.drawMotionVector(this.clampedLeftMotorSpeed,this.clampedRightMotorSpeed);this.shadowRoot.getElementById("forceVector").innerHTML=e}render(){return D`
    ...
    `}}V(ze,"properties",Pe.properties),V(ze,"styles",z`
    :host {
      display: inline-block;
      width: 400px;
      height: 300px;
  ...
  `),customElements.define("frc-differential-drivebase",ze);var De=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-differential-drivebase",elementConfig:Pe});const Oe={properties:{frontLeftMotorSpeed:{type:Number,attribute:"front-left-motor-speed"},frontRightMotorSpeed:{type:Number,attribute:"front-right-motor-speed"},rearLeftMotorSpeed:{type:Number,attribute:"rear-left-motor-speed"},rearRightMotorSpeed:{type:Number,attribute:"rear-right-motor-speed"}}};class Ue extends P{constructor(){super(),I(this,e),this.frontLeftMotorSpeed=0,this.frontRightMotorSpeed=0,this.rearLeftMotorSpeed=0,this.rearRightMotorSpeed=0;new ResizeObserver((()=>{this.resized()})).observe(this)}drawMotionVector(e,t,i,s){const r=this.shadowRoot.getElementById("svg").getBoundingClientRect(),n=.13*r.width,o=r.width-2*(n+20),a=r.height-40,l=Math.min(o,a)/2-16,d={x:(e-t-i+s)/4,y:(e+t+i+s)/4},h=(-e+t-i+s)/4,c=Math.hypot(d.x,d.y),u=Math.atan2(d.y,d.x);if(Math.abs(h)<=.01&&c<=.01)return function(e){const t=e/2;return`<g class="x">\n    <line \n      x1="${-t}"\n      y1="${-t}"\n      x2="${t}"\n      y2="${t}"\n    />\n   \n    <line \n      x1="${-t}"\n      y1="${t}"\n      x2="${t}"\n      y2="${-t}"\n    />\n  </g>`}(.2*r.width);let p="",m="",b="";return Math.abs(h)>.01&&(p=Be(0,l,-h*Math.PI,0,8),m=Be(Math.PI,l,-h*Math.PI,0,8)),c>.01&&(b=Re(c*l,-u,0,8)),`<g class="arrow">${p} ${m} ${b}</g>`}drawDrivetrain(){const e=this.shadowRoot.getElementById("svg").getBoundingClientRect(),t=.13*e.width,i=Math.min(.13*e.width,.15*e.height),s=20;return`\n      <rect \n        width="calc(100% - ${2*(t+s)}px)" \n        height="calc(100% - 40px)"\n        x="${t+s}" \n        y="20px" \n      />\n    `+`\n      <rect \n        width="${t}px" \n        height="${2*i}" \n        x="20px" \n        y="20px" \n      />\n    `+`\n      <rect \n        width="${t}px" \n        height="${2*i}" \n        x="calc(100% - ${t+s}px)" \n        y="20px" \n      />\n    `+`\n      <rect \n        width="${t}px" \n        height="${2*i}" \n        x="20px"\n        y="calc(100% - ${2*i+20}px)"\n      />\n    `+`\n      <rect \n        width="${t}px" \n        height="${2*i}" \n        x="calc(100% - ${t+s}px)" \n        y="calc(100% - ${2*i+20}px)"\n      />\n    `}getFlForegroundStyle(){return this.getForegroundStyle(this.frontLeftMotorSpeed)}getFrForegroundStyle(){return this.getForegroundStyle(this.frontRightMotorSpeed)}getRlForegroundStyle(){return this.getForegroundStyle(this.rearLeftMotorSpeed)}getRrForegroundStyle(){return this.getForegroundStyle(this.rearRightMotorSpeed)}getForegroundStyle(i){const s=R(this,e,t).call(this,i,-1,1);return s>0?`\n        height: ${Math.abs(s)/2*100}%;\n        top: auto;\n        bottom: 50%;\n      `:`\n        height: ${Math.abs(s)/2*100}%;\n        top: 50%;\n        bottom: auto;\n      `}firstUpdated(){let e=this.drawMotionVector(0,0,0,0);this.shadowRoot.getElementById("drivetrain").innerHTML=this.drawDrivetrain(),this.shadowRoot.getElementById("forceVector").innerHTML=e}resized(){let i=this.drawMotionVector(R(this,e,t).call(this,this.frontLeftMotorSpeed),R(this,e,t).call(this,this.frontRightMotorSpeed),R(this,e,t).call(this,this.rearLeftMotorSpeed),R(this,e,t).call(this,this.rearRightMotorSpeed));this.shadowRoot.getElementById("forceVector").innerHTML=i;const s=this.shadowRoot.getElementById("svg").getBoundingClientRect();this.shadowRoot.getElementById("forceVector").style.transform=`translate(${.5*s.width}px, ${.5*s.height}px)`,this.shadowRoot.getElementById("drivetrain").innerHTML=this.drawDrivetrain()}updated(i){super.updated(i);let s=this.drawMotionVector(R(this,e,t).call(this,this.frontLeftMotorSpeed),R(this,e,t).call(this,this.frontRightMotorSpeed),R(this,e,t).call(this,this.rearLeftMotorSpeed),R(this,e,t).call(this,this.rearRightMotorSpeed));this.shadowRoot.getElementById("forceVector").innerHTML=s}render(){return D`
      <div class="diff-drive-container">
    ...
    `}}e=new WeakSet,t=function(e){return Math.min(1,Math.max(e,-1))},V(Ue,"properties",Oe.properties),V(Ue,"styles",[fe,z`
      :host {
        width: 400px;
        height: 300px;
        padding: 0 10px;
    ...
    `]),customElements.define("frc-mecanum-drivebase",Ue);const je=[De,Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-mecanum-drivebase",elementConfig:Oe})],Fe={properties:{x:{type:Number},y:{type:Number},z:{type:Number},max:{type:Number,defaultValue:1},min:{type:Number,defaultValue:-1},center:{type:Number},precision:{type:Number,defaultValue:2},hideText:{type:Boolean,attribute:"hide-text"},numTickMarks:{type:Number,defaultValue:3,attribute:"num-tick-marks"},unit:{type:String,defaultValue:"g"}}};class qe extends U{renderAccelerometer(e,t){return D`
    ...
    `}}V(qe,"properties",Fe.properties),V(qe,"styles",z`
    :host {
      display: inline-flex;
      flex-direction: column;
      height: auto;
  ...
  `),customElements.define("frc-3-axis-accelerometer",qe);var He=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-3-axis-accelerometer",elementConfig:Fe});const We={properties:{value:{type:Number,primary:!0},max:{type:Number,defaultValue:1},min:{type:Number,defaultValue:-1},center:{type:Number},precision:{type:Number,defaultValue:2},hideText:{type:Boolean,attribute:"hide-text"},numTickMarks:{type:Number,defaultValue:3,attribute:"num-tick-marks"},unit:{type:String}}};class Ke extends U{render(){const e=Math.min(this.min,this.max),t=Math.max(this.min,this.max);return D`
      ...
      `:""}
    `}}V(Ke,"properties",We.properties),V(Ke,"styles",[fe,z`
      :host {
        display: inline-block;
        width: 300px;
        height: auto;
    ...
    `]),customElements.define("frc-number-bar",Ke);var Ge=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-number-bar",elementConfig:We,default:Ke});const Qe={properties:{value:{type:Number,primary:!0},max:{type:Number,defaultValue:1},min:{type:Number,defaultValue:-1},center:{type:Number},precision:{type:Number,defaultValue:2},hideText:{type:Boolean,attribute:"hide-text"},numTickMarks:{type:Number,defaultValue:3,attribute:"num-tick-marks"},unit:{type:String,defaultValue:"g"}}};class Xe extends Ke{}V(Xe,"properties",Qe.properties),customElements.define("frc-accelerometer",Xe);var Je=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-accelerometer",elementConfig:Qe});const Ye=["Unknown","Practice","Qualification","Elimination"],Ze={properties:{matchType:{type:Number,attribute:"match-type"},matchNumber:{type:Number,attribute:"match-number"},eventName:{type:String,attribute:"event-name"},fmsControlData:{type:Number,attribute:"fms-control-data"}}};class et extends U{getRobotState(){return this.isEnabled()?this.isTest()?"Test":this.isAuto()?"Autonomous":"Teleoperated":"Disabled"}isEnabled(){return!!(1&this.fmsControlData)}isAuto(){return!!(2&this.fmsControlData)}isTest(){return!!(4&this.fmsControlData)}isEmergencyStopped(){return!!(8&this.fmsControlData)}isFmsAttached(){return!!(16&this.fmsControlData)}isDsAttached(){return!!(32&this.fmsControlData)}render(){return D`
      <p>
        <strong>
    ...
    `}}V(et,"properties",Ze.properties),V(et,"styles",z`
    p {
      margin: 5px 0;
    }
    p:first-child {
  ...
  `),customElements.define("frc-camera",at);var lt=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-camera",elementConfig:ot});const dt={properties:{distance:{type:Number},speed:{type:Number}}};class ht extends U{render(){return D`   
    ...
    `}}V(ht,"properties",dt.properties),V(ht,"styles",z`
    :host {
      display: inline-grid;
  ...
  `),customElements.define("frc-encoder",ht);var ct=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-encoder",elementConfig:dt});const ut={properties:{value:{type:Number,primary:!0},hideLabel:{type:Boolean,attribute:"hide-label"},precision:{type:Number,defaultValue:2}}};class pt extends P{constructor(){super(),this.value=0,this.hideLabel=!1,this.precision=2,this.tickAngles=[];for(let e=0;e<=360;e+=5)this.tickAngles.push(e);this.degreeLabelAngles=[];for(let e=0;e<360;e+=45)this.degreeLabelAngles.push(e)}firstUpdated(){this.containerNode=this.shadowRoot.querySelector(".container");new ResizeObserver((()=>{this.resized()})).observe(this)}resized(){const{width:e,height:t}=this.getBoundingClientRect();this.containerNode.style.setProperty("--gyro-container-size",`${Math.min(e,t)}px`),this.requestUpdate()}getWidth(){const e=this.shadowRoot.querySelector("svg");if(!e)return 0;const{width:t}=e.getBoundingClientRect();return t}renderTicks(){const e=this.getWidth(),t=e/2-e/20,i=e/2-e/10;return j`
      ${this.tickAngles.map((s=>{const r=s*Math.PI/180,n=e/2+t*Math.cos(r),o=e/2+t*Math.sin(r),a=e/2+i*Math.cos(r),l=e/2+i*Math.sin(r);return j`
          <line
            class="tick ${s%45==0?"big":""}"
            x1="${n}" y1="${o}" x2="${a}" y2="${l}"
          />
        `}))}
    `}renderEdge(){const e=this.getWidth();return j`
      <circle class="edge" cx="${.5*e}" cy="${.5*e}" r="${.4*e}" />
    `}renderDialHand(){const e=this.getWidth(),t=e/2-e/20-e/40,i=(this.value-90)*Math.PI/180,s=e/2,r=e/2,n=e/2+t*Math.cos(i),o=e/2+t*Math.sin(i);return j`
      <line
        class="dial-hand"
        x1="${s}" y1="${r}" x2="${n}" y2="${o}"
      />
    `}renderDialCircle(){const e=this.getWidth();return j`
      <circle class="dial-circle" cx="${.5*e}" cy="${.5*e}" r="${.04*e}" />
    `}renderDegreeLabels(){const e=this.getWidth(),t=e/2+e/100,i=this.shadowRoot.querySelector("svg");return i&&i.style.setProperty("--degree-label-font-size",.055*e+"px"),j`
      ${this.degreeLabelAngles.map((i=>{const s=(i-90)*Math.PI/180,r=e/2+t*Math.cos(s),n=e/2+t*Math.sin(s);return j`
          <text class="degree-label" x="${r}" y="${n}">${i}</text>
        `}))}
    `}renderAngleLabel(){if(this.hideLabel)return null;const e=this.getWidth(),t=this.shadowRoot.querySelector("svg");t&&t.style.setProperty("--angle-label-font-size",.08*e+"px");return j`
      <text class="angle-label" x="${e/2}" y="${e+.15*e}">
        ${this.value.toFixed((i=this.precision,s=0,r=100,Math.min(r,Math.max(i,s))))}&deg;
      </text>
    `;var i,s,r}render(){return j`
      <div class="container">
        <svg>
          ${this.renderEdge()}
          ${this.renderTicks()}
    ...
    `}}V(pt,"properties",ut.properties),V(pt,"styles",[fe,z`
      :host { 
        display: inline-flex;
        justify-content: center;
        align-items: center;
    ...
    `]),customElements.define("frc-gyro",pt);var mt=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-gyro",elementConfig:ut});const bt={properties:{value:{type:Boolean}},slots:[{name:"true"},{name:"false"}],layout:{type:"absolute"},demos:[{html:'\n      <frc-if>\n        <span slot="true">Visible if true</span>\n        <span slot="false">Visible if false</span>\n      </frc-if>\n    '}]};class gt extends P{render(){return this.value?D`
        <slot name="true"></slot>
      `:D`
      <slot name="false"></slot>
    `}}V(gt,"properties",bt.properties),V(gt,"styles",z`
    :host {
      display: inline-block;
      position: absolute;
    }
  `),customElements.define("frc-if",gt);var yt=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-if",elementConfig:bt});const ft={properties:{value:{type:String,defaultValue:"Off",primary:!0}}};class vt extends U{constructor(){super(),this.buttons=["Off","On","Forward","Reverse"]}setValue(e){this.value=e}render(){return D`   
  ...
  `),V(vt,"properties",ft.properties),customElements.define("frc-relay",vt);var wt=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-relay",elementConfig:ft});const xt={properties:{toggled:{type:Boolean,defaultValue:!1,primary:!0},label:{type:String,defaultValue:"Button"}}};class St extends U{onClick(){this.toggled=!this.toggled}render(){return D`   
    ...
    `]),V(St,"properties",xt.properties),customElements.define("frc-toggle-button",St);var $t=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",elementName:"frc-toggle-button",elementConfig:xt});const Et={properties:{options:{type:Array,changeEvent:"optionsUpdate",defaultValue:["On","Off"],inputType:"StringArray"},value:{primary:!0,type:String,changeEvent:"change",inputType:"StringDropdown",allowCustomValues:!1,getOptions(){return this.options}}}};class _t extends P{constructor(){super(),I(this,i),I(this,r),this.options=["On","Off"]}async setValue(e){this.value=e}updated(e){var t;e.has("options")&&!this.options.includes(this.value)&&(this.value=null!=(t=this.options[0])?t:""),e.has("value")&&R(this,i,s).call(this),e.has("options")&&R(this,r,n).call(this)}render(){return D`   
      ...
      `))}
    `}}i=new WeakSet,s=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))},r=new WeakSet,n=function(){this.dispatchEvent(new CustomEvent("optionsUpdate",{detail:{options:this.options},bubbles:!0,composed:!0}))},V(_t,"properties",Et.properties),V(_t,"styles",z`
    :host {
      font-size: 15px;
      display: inline-flex;
      flex-direction: column;
  ...
  `),V(Pt,"properties",{element:{type:HTMLElement,attribute:!1},propertyHandler:{type:Object,attribute:!1},propertyName:{type:String}});customElements.define("dashboard-string-property-view",class extends Pt{onInputChange(){this.setValue(this.inputElement.value)}renderInputField(){var e;return D`
      <vaadin-text-field 
        part="input" 
      ...
      ></vaadin-text-field>
    `}});customElements.define("dashboard-boolean-property-view",class extends Pt{onInputChange(){this.setValue(this.inputElement.checked)}renderInputField(){return D`
      <vaadin-checkbox
        part="input"
        ...
        theme="small"
      ></vaadin-checkbox>
    `}});customElements.define("dashboard-number-property-view",class extends Pt{onInputChange(){this.setValue(this.inputElement.value)}renderInputField(){return D`
      <vaadin-number-field
        part="input"
        value="${this.getValue()}"
        @change="${this.onInputChange}"
        ...
        has-controls
      ></vaadin-number-field>
    `}});customElements.define("dashboard-color-picker-property-view",class extends Pt{onInputChange(){this.setValue(this.inputElement.value)}renderInputField(){return D`
      <input
        part="input"
        type="color"
        .value="${this.getValue()}"
        ...
        theme="small"
      />
    `}});customElements.define("dashboard-string-dropdown-property-view",class extends Pt{allowCustomValues(){return!("allowCustomValues"in this.property)||this.property.allowCustomValues}onInputChange(){this.setValue(this.inputElement.value)}renderInputField(){return D`
      <vaadin-combo-box 
        part="input"
    ...
    `}});customElements.define("dashboard-number-array-property-view",class extends Pt{update(e){super.update(e),this.inputElement.selectedItems=this.getValue().map(((e,t)=>({value:t.toString(),autocomplete:e,display:e})))}onInputChange(){this.setValue(this.inputElement.selectedItems.map((e=>parseFloat(e.display))))}onCustomValueSet(e){const t=parseFloat(e.detail);isNaN(t)||(this.setValue(this.getValue().concat(t)),this.requestUpdate())}renderInputField(){return D`
    ...
    `}});const zt=[{value:"true",autocomplete:"true",display:"true"},{value:"false",autocomplete:"false",display:"false"}];customElements.define("dashboard-boolean-array-property-view",class extends Pt{onInputChange(){this.setValue(this.inputElement.selectedItems.map((e=>e.value.startsWith("true"))))}update(e){super.update(e),this.inputElement.selectedItems=this.getValue().map(((e,t)=>e?{value:`true${t.toString()}`,autocomplete:"true",display:"true"}:{value:`false${t.toString()}`,autocomplete:"false",display:"false"}))}renderInputField(){return D`
      <multiselect-combo-box
        part="input"
        theme="small"
        @change="${this.onInputChange}"
    ...
    `}});customElements.define("dashboard-string-array-property-view",class extends Pt{getValue(){var e;return null!=(e=super.getValue())?e:[]}update(e){super.update(e),this.inputElement.selectedItems=this.getValue().map(((e,t)=>({value:t.toString(),autocomplete:e,display:e})))}onInputChange(){this.setValue(this.inputElement.selectedItems.map((e=>e.display)))}onCustomValueSet(e){const t=e.detail;this.setValue(this.getValue().concat(t)),this.requestUpdate()}renderInputField(){return D`
      <multiselect-combo-box
        part="input"
        theme="small"
        allow-custom-values
    ...
    `}});customElements.define("dashboard-text-area-property-view",class extends Pt{onInputChange(){this.setValue(this.inputElement.value)}renderInputField(){var e;return D`
      <vaadin-text-area
        part="input"
        .value="${null!=(e=this.getValue())?e:""}"
        @change="${this.onInputChange}"
        ...
        ?disabled="${this.isDisabled()}"
      ></vaadin-text-area>
    `}});customElements.define("dashboard-function-property-view",class extends Pt{static get styles(){return[super.styles,z`
        vaadin-form-item {
    ...
    `}renderPropertyView(e,t){var i;const s=t.getProperty();switch(null!=(i=s.inputType)?i:s.type){case"String":return D`
        ...
        `;case"Function":return D`
          <dashboard-function-property-view
            ...
            .propertyHandler="${t}"
          ></dashboard-function-property-view>
        `}return D``}}V(Ot,"properties",{element:{type:HTMLElement,attribute:!1},connector:{type:F,attribute:!1}}),V(Ot,"styles",Dt),customElements.define("dashboard-properties-tool",Ot);const Ut=z`
  :host {
    display: block;
    font-family: sans-serif;
    font-size: 16px;
...
`;class jt extends P{constructor(){super(),this.label="",this.providerName="",this.source=null,this.level=0,this.selectedSourceKey="",this.selectedSourceProvider="",this.selectedSource=null,this.store=null,this.disabled=!1}get detailsElement(){return this.renderRoot.querySelector("details")}hasSources(){return this.source.hasChildren()}hasValue(){return this.source.hasValue()}isSelected(){return this.source===this.selectedSource}isSelectedKeyDescendent(){return!!this.selectedSource&&this.selectedSource.getKey().startsWith(this.source.getKey()+"/")}updated(e){e.has("selectedSource")&&this.isSelectedKeyDescendent()&&(this.detailsElement.open=!0)}firstUpdated(){this.store.subscribe(this.providerName,this.source.getKey(),(()=>{this.requestUpdate()}),!0)}onSelect(){const e=new CustomEvent("sourceSelect",{bubbles:!0,composed:!0,detail:{sourceKey:this.source.getKey(),sourceProvider:this.providerName}});this.dispatchEvent(e)}renderValue(){const e=this.source.getValue();return"boolean"==typeof e?D`
    ...
    `;var e}}V(jt,"styles",Ut),V(jt,"properties",{onlyChild:{type:Boolean,attribute:"only-child"},label:{type:String},providerName:{type:String},source:{type:Object},level:{type:Number},selectedSourceKey:{type:String},selectedSourceProvider:{type:String},selectedSource:{type:Object},store:{type:Object},disabled:{type:Boolean}}),customElements.define("dashboard-source-view",jt);class Ft extends P{constructor(){super(),this.sourceKey="",this.sourceProvider="",this.store=null,this.disabled=!1}get sourceProviderNames(){var e,t;return null!=(t=null==(e=this.store)?void 0:e.getSourceProviderNames())?t:[]}firstUpdated(){this.store.sourceProviderAdded((e=>{this.store.subscribeAll(e,(()=>{this.requestUpdate()}),!0)})),this.sourceProviderNames.forEach((e=>{this.store.subscribeAll(e,(()=>{this.requestUpdate()}),!0)}))}updated(e){}renderSources(e){var t;const i=this.store.getSource(e,""),s=null!=(t=null==i?void 0:i.getChildren())?t:{},r=Object.entries(s),n=this.sourceKey&&this.store?this.store.getSource(this.sourceProvider,this.sourceKey):null;return D`
      ${r.map((([t,i])=>D`
        <dashboard-source-view
  ...
  `),V(Ft,"properties",{sourceKey:{type:String},sourceProvider:{type:String},store:{type:Object},disabled:{type:Boolean}}),customElements.define("dashboard-sources-view",Ft);const qt=z`
  :host {
    display: flex;
    flex-direction: column;
    padding: 15px 10px;
...
`;class Ht extends P{constructor(){super(),this.element=null,this.connector=null,this.sourceKeys={}}get webbit(){var e;return this.element&&(null==(e=this.connector)?void 0:e.getElementWebbit(this.element))}get sourceProvider(){var e,t;return null!=(t=null==(e=this.webbit)?void 0:e.sourceProvider)?t:""}set sourceProvider(e){this.webbit&&(this.webbit.sourceProvider=e)}get sourceKey(){var e,t;return null!=(t=null==(e=this.webbit)?void 0:e.sourceKey)?t:""}set sourceKey(e){this.webbit&&(this.webbit.sourceKey=e)}get store(){var e;return null==(e=this.connector)?void 0:e.getStore()}get defaultSourceProvider(){var e;return null==(e=this.store)?void 0:e.getDefaultSourceProvider()}get sourceProviderNames(){var e,t;return null!=(t=null==(e=this.store)?void 0:e.getSourceProviderNames())?t:[]}onSourceKeyInputChange(e){const t=e.target||e.path[0];this.sourceKey=t.value,this.requestUpdate()}onSourceProviderInputChange(e){const t=e.target||e.path[0];this.sourceProvider=t.value,this.requestUpdate()}onSourceSelect(e){const{sourceKey:t,sourceProvider:i}=e.detail;this.sourceKey=t,this.sourceProvider=i,this.requestUpdate()}getSourceKeyItems(){var e;return[...null!=(e=this.sourceKeys[this.sourceProvider])?e:[]]}updateSourceKeySet(e,t){this.store.getSource(e,t)?this.sourceKeys[e].has(t)||(this.sourceKeys[e].add(t),this.requestUpdate()):this.sourceKeys[e].has(t)&&(this.sourceKeys[e].delete(t),this.requestUpdate())}firstUpdated(){this.store.sourceProviderAdded((e=>{this.sourceKeys[e]=new Set,this.store.subscribeAll(e,((t,i)=>{this.updateSourceKeySet(e,i)}),!0)})),this.sourceProviderNames.forEach((e=>{this.sourceKeys[e]=new Set,this.store.subscribeAll(e,((t,i)=>{this.updateSourceKeySet(e,i)}),!0)}))}render(){var e,t,i;const s=this.element?null==(e=this.connector)?void 0:e.getElementWebbit(this.element):null,r=!this.element||!s;return D`
      ...
      <dashboard-sources-view
        ...
        ?disabled=${r}
      ></dashboard-sources-view>
    `}}function Wt(e,t){const i=e.getMatchingElementConfig(t),s=t.tagName.toLowerCase();return i?"string"==typeof i.displayName?i.displayName:"function"==typeof i.displayName?i.displayName(t):s:s}V(Ht,"styles",qt),V(Ht,"properties",{element:{type:HTMLElement,attribute:!1},connector:{type:F,attribute:!1}}),customElements.define("dashboard-sources-tool",Ht);class Kt extends P{constructor(){super(),this.slot="",this.level=0}render(){return D`
  ...
  `),V(Kt,"properties",{slot:{type:String},level:{type:Number}}),customElements.define("dashboard-element-tree-slot-node",Kt);const Gt=z`
  :host {
    display: block;
    font-family: sans-serif;
    font-size: 16px;
...
`;class Qt extends P{constructor(){super(),I(this,l),I(this,h),I(this,u),I(this,m),I(this,g),I(this,f),I(this,w),this.connector=null,this.element=null,this.selectedElement=null,this.level=0}static get properties(){return{connector:{type:F,attribute:!1},element:{type:HTMLElement,attribute:!1},selectedElement:{type:HTMLElement,attribute:!1},level:{type:Number}}}get headerElement(){return this.renderRoot.querySelector(".header")}get detailsElement(){return this.renderRoot.querySelector("details")}get elementConfig(){var e,t;return null!=(t=null==(e=this.connector)?void 0:e.getMatchingElementConfig(this.element))?t:null}updated(e){e.has("selectedElement")&&this.selectedElement&&this.element.contains(this.selectedElement)&&(this.detailsElement.open=!0)}firstUpdated(){const e=this.connector.getElementWebbit(this.element);null==e||e.subscribe((e=>{this.requestUpdate()})),this.connector.subscribeElementConnected((()=>this.requestUpdate())),this.connector.subscribeElementDisconnected((()=>this.requestUpdate()));new MutationObserver((()=>{this.requestUpdate()})).observe(this.element,{childList:!0,subtree:!0,attributeFilter:["id","slot"]})}renderAttributes(){return["id","slot"].filter((e=>this.element.hasAttribute(e))).map((e=>D`
      ...
      >
        ...
        ${R(this,l,d).call(this)?D`
          <div class="nodes">
            ${R(this,w,x).call(this).map((({name:e,elements:t})=>D`
              ${t.map((e=>D`
    ...
    `;var t}}l=new WeakSet,d=function(){return this.element.children.length>0},h=new WeakSet,c=function(){return this.element===this.selectedElement},u=new WeakSet,p=function(e){const t=new CustomEvent(e,{bubbles:!0,composed:!0,detail:{element:this.element,name:this.connector.getMatchingElementSelector(this.element)}});this.dispatchEvent(t)},m=new WeakSet,b=function(e){const t=e.target||e.path[0],i=this.renderRoot.querySelector(".caret");i&&i.contains(t)||R(this,u,p).call(this,"elementSelect")},g=new WeakSet,y=function(){R(this,u,p).call(this,"elementPreviewStart")},f=new WeakSet,v=function(){R(this,u,p).call(this,"elementPreviewEnd")},w=new WeakSet,x=function(){const e={"":[]};return[...this.element.children].forEach((t=>{var i;const s=null!=(i=t.getAttribute("slot"))?i:"";void 0===e[s]&&(e[s]=[]),e[s].push(t)})),Object.entries(e).map((([e,t])=>({name:e,elements:t})))},V(Qt,"styles",Gt),customElements.define("dashboard-element-tree-node",Qt);const Xt=z`
  :host {
    display: block;
    font-family: sans-serif;
    font-size: 16px;
...
`;class Jt extends P{static get properties(){return{connector:{type:F,attribute:!1},selectedElement:{type:HTMLElement,attribute:!1}}}constructor(){super(),this.connector=null,this.selectedElement=null}firstUpdated(){this.connector.subscribeElementConnected((()=>this.requestUpdate())),this.connector.subscribeElementDisconnected((()=>this.requestUpdate()))}render(){return D`
  ...
  `),V(ti,"properties",{connector:{type:F,attribute:!1},element:{type:HTMLElement,attribute:!1},allowedChildren:{type:Array,attribute:!1},_selectedTab:{state:!0}}),customElements.define("dashboard-element-demo-tabs",ti);class ii extends P{render(){return D`<slot></slot>`}}V(ii,"styles",z`
    :host {
      display: none;
      width: 100%;
      height: 100%;
  ...
  `),V(ri,"properties",{connector:{type:F,attribute:!1},element:{type:HTMLElement,attribute:!1}}),customElements.define("dashboard-menu",ri);const ni=z`
  :host {
    display: block;
    padding: 5px;
    font-family: sans-serif;
...
`;class oi extends P{constructor(){super(),this.element=null,this.connector=null,this._flask=null}get _editor(){return this.renderRoot.querySelector("#editor")}firstUpdated(){this._flask=new W(this._editor,{language:"js",styleParent:this.renderRoot})}updated(e){if(e.has("element")&&this.element){const e=K.exports.html(this.element.outerHTML,{"wrap-attributes":"force-expand-multiline"});this._flask.updateCode(e)}}_onSave(){const e=this._flask.getCode(),t=document.createElement("div");t.innerHTML=e;const i=t.firstElementChild;if(i&&i.nodeName===this.element.nodeName){for(this.element.getAttributeNames().forEach((e=>{i.hasAttribute(e)||this.element.removeAttribute(e)})),i.getAttributeNames().forEach((e=>{this.element.setAttribute(e,i.getAttribute(e))}));this.element.lastChild;)this.element.removeChild(this.element.lastChild);[...i.childNodes].forEach((e=>{this.element.append(e)}))}}render(){return this.element?D`
      <div class="container">
        <div class="editor">
          <div id="editor"></div>
        </div>
    ...
    `:D``}}V(oi,"properties",{element:{type:HTMLElement,attribute:!1},connector:{type:F,attribute:!1}}),V(oi,"styles",ni),customElements.define("dashboard-edit-html",oi);const ai=z`
  :host {
    display: flex;
    flex-direction: row;
    font-family: sans-serif;
...
`;class li extends P{constructor(){super(),this.store=null,this.elementConfigs={},this.elementNames=[],this.connector=null,this._selectedElement=null,this._previewedElement=null,this._selectedTab=null,this._allowedChildren=[],this.interact=null,this._dashboardSelections=null}get _containerElement(){return this.renderRoot.querySelector("#container")}firstUpdated(){this.connector=new F(this,this.store,N(M({},this.elementConfigs),{"dashboard-tab":{topLevel:!1,displayName:e=>e.getAttribute("tab-name")||"Tab",properties:{tabName:{type:"String",attribute:"tab-name",reflect:!0}},slots:[{name:""}],layout:{type:"absolute",movable:!1,resizable:!1}}})),this._dashboardSelections=new ei(this.connector,(e=>{this._selectedElement=e})),Object.entries(Bt).forEach((([e,t])=>{var i;(null==(i=t.topLevel)||i)&&this.elementNames.push(e)})),this.interact=new Zt(this.connector),this.innerHTML='\n      <dashboard-tab tab-name="TeleOperated" selected></dashboard-tab>\n      <dashboard-tab tab-name="Autonomous"></dashboard-tab>\n    ',this._selectedElement=this.querySelector("dashboard-tab"),this.requestUpdate();new MutationObserver((e=>{this.requestUpdate()})).observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["tab-name"]})}get _appLayout(){return this.renderRoot.querySelector("vaadin-app-layout")}updated(e){e.has("_selectedElement")&&(this._allowedChildren=function(e,t){if(!e)return[];const i=t.getMatchingElementConfig(e);return i?i.slots.map((({name:e,allowedChildren:i})=>({slot:e,allowedChildren:t.getElementConfigSelectors().filter((e=>i instanceof Array?i.includes(e):t.getElementConfig(e).topLevel))}))):[]}(this._selectedElement,this.connector),this.interact.addInteraction(this._selectedElement,this._containerElement),this._showSelectedTab()),(e.has("_selectedTab")||e.has("_selectedElement"))&&this._setInteractVisibility(),e.has("_previewedElement")&&this.interact.setPreviewedElement(this._previewedElement,this._containerElement)}_setInteractVisibility(){var e,t,i;const s="dashboard-tab"===(null==(t=null==(e=this._selectedElement)?void 0:e.tagName)?void 0:t.toLowerCase());(null==(i=this._appLayout)?void 0:i.drawerOpened)&&!s?this.interact.show():this.interact.hide()}_onElementSelect(e){this._selectedElement=e.detail.element}_onElementPreviewStart(e){this._previewedElement=e.detail.element}_onElementPreviewEnd(){this._previewedElement=null}_getSelectedTabIndex(){return[...this.querySelectorAll("dashboard-tab")].findIndex((e=>e===this._selectedElement||e.contains(this._selectedElement)))}_showSelectedTab(){const e=this._getSelectedTabIndex();[...this.querySelectorAll("dashboard-tab")].forEach(((t,i)=>{i===e?t.setAttribute("selected",""):t.removeAttribute("selected")}))}_getTabs(){return[...this.querySelectorAll("dashboard-tab")].map((e=>({label:e.getAttribute("tab-name")})))}_onDashboardTabChange(e){const t=[...this.children][e.detail.value];t&&!t.contains(this._selectedElement)&&(this._selectedElement=t)}_onDrawerOpenChange(){var e;this._setInteractVisibility();const t=!!(null==(e=this._appLayout)?void 0:e.drawerOpened);this._dashboardSelections.setListening(t),this._previewedElement=null,this.requestUpdate()}_onRemoveElement(e){this._selectedElement=e.detail.nextElement}_addTab(){const e=this.querySelectorAll("dashboard-tab").length,t=document.createElement("dashboard-tab");t.setAttribute("tab-name",`Tab ${e+1}`),this.append(t),0===e&&(this._selectedElement=t)}_onDashboardUpload(){const e=this.querySelector("dashboard-tab");e&&(this._selectedElement=e)}render(){var e;if(!this.connector)return D``;const t=this._getSelectedTabIndex();return D`
    ...
    `}}function di(e,t){const i=e.getElementConfig(t);if(null==i?void 0:i.demos){const[{html:e}]=i.demos;return e}return`<${t}></${t}>`}V(li,"styles",ai),V(li,"properties",{store:{type:G,attribute:!1},elementConfigs:{type:Object,attribute:!1},_selectedElement:{state:!0},_previewedElement:{state:!0},_selectedTab:{state:!0},_allowedChildren:{state:!0}}),customElements.define("dashboard-element-demo",li);const hi=z`
  :host {
    display: block;
    font-family: sans-serif;
    font-size: 16px;
...
`;class ci extends P{constructor(){super(),this.connector=null,this.element=null,this.allowedChildren=[],this._slot="",this._selectedConfigSelector=null}firstUpdated(){this.renderRoot.querySelectorAll("vaadin-combo-box").forEach((e=>{var t;const i=document.createElement("div");i.innerHTML="\n        <style>\n          vaadin-text-field::part(input-field)::after {\n            transition: none;\n          }\n        </style>\n      ",null==(t=null==e?void 0:e.shadowRoot)||t.prepend(i)}))}updated(e){var t,i,s,r;if(e.has("allowedChildren")){const e=null==(t=this.allowedChildren)?void 0:t[0];this._slot=null==e?void 0:e.slot,this._selectedConfigSelector=null==(i=null==e?void 0:e.allowedChildren)?void 0:i[0]}if(e.has("_slot")){const e=null==(s=this.allowedChildren)?void 0:s.find((({slot:e})=>this._slot===e));this._selectedConfigSelector=null==(r=null==e?void 0:e.allowedChildren)?void 0:r[0]}}_onSelect(e){const t=e.target||e.path[0];this._selectedConfigSelector=t.value}_onSlotSelect(e){const t=e.target||e.path[0];this._slot=t.value}_prependElement(){const e=document.createElement("div");e.innerHTML=di(this.connector,this._selectedConfigSelector),[...e.children].forEach((e=>{this._slot?e.setAttribute("slot",this._slot):e.removeAttribute("slot"),this.element.prepend(e)}))}_appendElement(){const e=document.createElement("div");e.innerHTML=di(this.connector,this._selectedConfigSelector),[...e.children].forEach((e=>{this._slot?e.setAttribute("slot",this._slot):e.removeAttribute("slot"),this.element.append(e)}))}render(){var e,t,i,s,r,n;if(!this.element)return D`<p>Select an element to view its properties.</p>`;const o=Wt(this.connector,this.element);if(!(null==(e=this.connector)?void 0:e.getElementWebbit(this.element)))return D`<p>There is no configuration for the <span>${o}</span> element.</p>`;const a=null!=(s=null==(i=null==(t=this.allowedChildren)?void 0:t.find((({slot:e})=>this._slot===e)))?void 0:i.allowedChildren)?s:[],l=null!=(n=null==(r=this.allowedChildren)?void 0:r.map((({slot:e})=>({value:e,label:e||"unnamed"}))))?n:[];return D`
