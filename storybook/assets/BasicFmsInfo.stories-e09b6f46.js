import{s as v,i as l,k as S,X as s}from"./property-7226fcdb-ca5eacb2.js";import"./icon-3261ec4d-907dd783.js";import{x as c}from"./lit-element-fe64f99e.js";import{o as T}from"./style-map-cd083d51.js";var N=Object.defineProperty,C=Object.getOwnPropertyDescriptor,f=(t,r,e,n)=>{for(var o=n>1?void 0:n?C(r,e):r,p=t.length-1,h;p>=0;p--)(h=t[p])&&(o=(n?h(r,e,o):h(o))||o);return n&&o&&N(r,e,o),o};const $=1,A=2,w=4,F=8,E=16,P=32,j=["Unknown","Practice","Qualification","Elimination"];class a extends S{constructor(){super(...arguments),this.matchType=0,this.matchNumber=0,this.eventName="",this.fmsControlData=0}getRobotState(){return this.isEnabled()?this.isTest()?"Test":this.isAuto()?"Autonomous":"Teleoperated":"Disabled"}isEnabled(){return!!(this.fmsControlData&$)}isAuto(){return!!(this.fmsControlData&A)}isTest(){return!!(this.fmsControlData&w)}isEmergencyStopped(){return!!(this.fmsControlData&F)}isFmsAttached(){return!!(this.fmsControlData&E)}isDsAttached(){return!!(this.fmsControlData&P)}render(){return s`
      <p>
        <strong>
