import{r as $,s as C,y as T,$ as h}from"./lit-element-ac510585.js";import{e as g}from"./query-assigned-elements-bd4ea1f7.js";import{i as u}from"./query-99a7b366.js";import{s as d}from"./transform-e88a9a97.js";import{i as S}from"./style-map-fc25a154.js";function z(r,e,t){r=+r,e=+e,t=(o=arguments.length)<2?(e=r,r=0,1):o<3?1:+t;for(var a=-1,o=Math.max(0,Math.ceil((e-r)/t))|0,c=new Array(o);++a<o;)c[a]=r+a*t;return c}var A=Object.defineProperty,D=Object.getOwnPropertyDescriptor,l=(r,e,t,a)=>{for(var o=a>1?void 0:a?D(e,t):e,c=r.length-1,i;c>=0;c--)(i=r[c])&&(o=(a?i(e,t,o):i(o))||o);return a&&o&&A(e,t,o),o};function G(r){return r*Math.PI/180}function f(r){return r*180/Math.PI}function L(r,e,t){return Math.min(t,Math.max(r,e))}function n(r,e=!1){const t=G(-(r-90));return[e?-Math.cos(t):Math.cos(t),Math.sin(t)]}class s extends C{constructor(){super(...arguments),this.value=0,this.hideLabel=!1,this.precision=2,this.counterClockwise=!1,this.fromRadians=!1}setLabels(){const e=this.getGyroRadius();d(this._labels).selectAll("text").data([0,45,90,135,180,-135,-90,-45]).join(t=>t.append("text").attr("text-anchor","middle").attr("alignment-baseline","middle").attr("font-size",15).attr("fill","var(--frc-gyro-color, #000)").text(a=>`${a}°`)).attr("x",t=>n(t,this.counterClockwise)[0]*(e+30)).attr("y",t=>-n(t,this.counterClockwise)[1]*(e+30))}setDialAngle(){const e=this.getGyroRadius(),t=this.fromRadians?f(this.value):this.value;d(this._dial).attr("x2",n(t,this.counterClockwise)[0]*(e-7)).attr("y2",-n(t,this.counterClockwise)[1]*(e-7))}addTicks(e,t,a,o){const c=this.getGyroRadius();d(e).selectAll("line").data(z(0,360,a)).join(i=>i.append("line").attr("stroke","var(--frc-gyro-color, #000)").attr("stroke-width",o)).attr("x1",i=>n(i)[0]*c).attr("y1",i=>-n(i)[1]*c).attr("x2",i=>n(i)[0]*(c+t)).attr("y2",i=>-n(i)[1]*(c+t))}firstUpdated(){new ResizeObserver(()=>{this.resized()}).observe(this),this.resized()}resized(){const e=this.getSize();d(this._svg).attr("width",e).attr("height",e),d(this._gyro).attr("transform",`translate(${e/2},${e/2})`);const t=this.getGyroRadius();d(this._gyroEdge).attr("r",t),this.addTicks(this._minorTicks,5,5,1),this.addTicks(this._majorTicks,10,45,2),this.setLabels(),this.setDialAngle()}getSize(){const{width:e}=this.getBoundingClientRect();return e}getGyroRadius(){return this.getSize()/2-53}updated(e){(e.has("value")||e.has("fromRadians")||e.has("counterClockwise"))&&this.setDialAngle(),e.has("counterClockwise")&&this.setLabels()}render(){const t=`${(this.fromRadians?f(this.value):this.value).toFixed(L(this.precision,0,100))}`;return T`
        <div>
        <svg>
          <g class="gyro">
        ...
        ${this.hideLabel?null:h`<label>${t}&deg</label> `}
        </div>
    `}}s.styles=$`
    :host {
...
//# sourceMappingURL=Gyro.stories-ca7c774a.js.map
