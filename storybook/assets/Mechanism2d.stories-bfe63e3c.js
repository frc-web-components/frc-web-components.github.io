import{i as M,s as v,b as g,x as f}from"./lit-element-336289fd.js";import{n as l}from"./property-a00a2a3e.js";import{r as $}from"./state-0f1c18cb.js";import{e as w}from"./query-5f0bf39c.js";import{o as C}from"./style-map-1987af2b.js";var k=Object.defineProperty,S=Object.getOwnPropertyDescriptor,a=(i,e,t,s)=>{for(var r=s>1?void 0:s?S(e,t):e,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(e,t,r):n(r))||r);return s&&r&&k(e,t,r),r};class c extends v{constructor(){super(...arguments),this.backgroundColor="#000020",this.dims=[3,3],this.roots=[],this.mechanism2d=this.getMechanism2d()}firstUpdated(){new ResizeObserver(()=>{this.resized()}).observe(this),requestAnimationFrame(()=>{this.updateMechanism2d()})}getMech2dSize(){const{width:e,height:t}=this.getBoundingClientRect(),[s,r]=this.dims;return r/s*e<t?[e,r/s*e]:[s/r*t,t]}resized(){this.requestUpdate()}getSize(){const{width:e}=this.getBoundingClientRect();return e}updated(e){e.has("backgroundColor")&&this._svg.style.setProperty("background-color",this.backgroundColor),e.has("dims")&&this.requestUpdate()}updateMechanism2d(){this.mechanism2d=this.getMechanism2d(),requestAnimationFrame(()=>{this.updateMechanism2d()})}getMechanism2d(){return{backgroundColor:this.backgroundColor,dims:this.dims,roots:this.roots}}render(){const[e,t]=this.getMech2dSize();return g`
    ...
    `}renderMechanism2dRoot(e){const[t,s]=this.dims,[r,o]=this.getMech2dSize(),n=e.x/t*r,h=e.y/s*o;return g`
      <g style="transform: translate(${n}px, ${o-h}px)">
        ${e.children.map(m=>this.renderMechanism2dLine(m))}
      </g>
    `}renderMechanism2dLine(e){const[t]=this.dims,[s]=this.getMech2dSize(),r=s/t*e.length,o=e.angle*Math.PI/180,n=Math.cos(o)*r,h=-Math.sin(o)*r,m=Math.max(1,e.weight*2/3);return g`
      <line stroke=${e.color} stroke-width=${m} x1="0" y1="0" x2="${n}px" y2="${h}px"  />
      <g style="transform: translate(${n}px, ${h}px) rotate(${-e.angle}deg)">
