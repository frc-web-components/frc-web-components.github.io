import{i as _,s as $,x as o}from"./lit-element-336289fd.js";import{n as l}from"./property-a00a2a3e.js";import{o as C}from"./style-map-1987af2b.js";var w=Object.defineProperty,T=Object.getOwnPropertyDescriptor,m=(r,e,t,s)=>{for(var a=s>1?void 0:s?T(e,t):e,u=r.length-1,d;u>=0;u--)(d=r[u])&&(a=(s?d(e,t,a):d(a))||a);return s&&a&&w(e,t,a),a},N=(r,e,t)=>{if(!e.has(r))throw TypeError("Cannot "+t)},P=(r,e,t)=>{if(e.has(r))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(r):e.set(r,t)},E=(r,e,t)=>(N(r,e,"access private method"),t),h,v;class i extends ${constructor(){super(...arguments),P(this,h),this.value=0,this.min=-1,this.max=1,this.blockIncrement=.05}onChange(e){this.value=parseFloat(e.target.value),E(this,h,v).call(this)}firstUpdated(){setTimeout(()=>{const e=this.renderRoot.querySelector("#slider");e&&(e.value=this.value)})}render(){const e=Math.min(this.min,this.max),t=Math.max(this.min,this.max),s=Math.max(e,Math.min(this.value,t));return o`
    ...
    `}}h=new WeakSet;v=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))};i.styles=_`
    :host {
  ...
  theme: 'light'
})`,...(y=(f=c.parameters)==null?void 0:f.docs)==null?void 0:y.source}}};var x,g,b;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`createNumberSliderStory({
  theme: 'dark'
})`,...(b=(g=n.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};const A=["LightTheme","DarkTheme"];export{n as DarkTheme,c as LightTheme,A as __namedExportsOrder,O as default};
