import{r as u,s as c,$ as h}from"./lit-element-ac510585.js";import{e as i}from"./query-assigned-elements-bd4ea1f7.js";import"./index-84aad64d.js";import"./index-0665b33f.js";var x=Object.defineProperty,l=Object.getOwnPropertyDescriptor,s=(n,e,r,p)=>{for(var a=p>1?void 0:p?l(e,r):e,m=n.length-1,o;m>=0;m--)(o=n[m])&&(a=(p?o(e,r,a):o(a))||a);return p&&a&&x(e,r,a),a};function b(n,e,r){return Math.min(r,Math.max(n,e))}class t extends c{constructor(){super(...arguments),this.value=0,this.min=-1,this.max=1,this.center=0,this.precision=2,this.hideText=!1,this.numTickMarks=3,this.unit=""}render(){const e=Math.min(this.min,this.max),r=Math.max(this.min,this.max);return h`
      <frc-bar
        value="${this.value}"
        min="${e}"
        max="${r}"
...
//# sourceMappingURL=index-15bfa3e8.js.map
