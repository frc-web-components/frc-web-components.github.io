import{s as D,i as p,k as U,X as j,Y as w}from"./property-7226fcdb-ca5eacb2.js";import"./bar.es-60d50a7c.js";import"./axis.es-ac91c8c7.js";import{h as F}from"./query-b33b5ea2-b51c1579.js";import{E as k}from"./transform-bc2573b1-2dde8094.js";function q(o){return o*180/Math.PI}function Y(o,t,e,r){return`<line x1="${o}" y1="${t}" x2="${e}" y2="${r}" />`}function T(o,t,e){return`<polygon 
            points="${o.x},${o.y} ${t.x},${t.y} ${e.x},${e.y}" />`}function E(o,t,e,r){const i=r*Math.PI/180;return{x:o+e*Math.cos(i),y:t-e*Math.sin(i)}}function J(o,t,e,r,i){const s=E(o,t,e,i),n=E(o,t,e,r),a=i-r<=180?"0":"1",d=i>r?1:0;return["M",s.x,s.y,"A",e,e,0,a,d,n.x,n.y].join(" ")}function K(o,t,e,r,i){return`<path d="${J(o,t,e,r,i)}"/>`}function Q(o,t,e,r){const i=t/2,s=Math.cos(o),n=Math.sin(o),a=Math.cos(o+Math.PI/2)*i,d=Math.sin(o+Math.PI/2)*i,c={x:s*r-a+e,y:n*r-d},h={x:s*r+a+e,y:n*r+d},l={x:s*(t+r)+e,y:n*(t+r)};return T(c,h,l)}function C(o,t,e,r){const i=Math.cos(t)*o,s=Math.sin(t)*o,n=Y(e,0,i+e,s),a=Q(t,r,e,o);return n+a}function Z(o,t,e,r){const i=e/t,s=q(i);return K(r,0,t,q(o),q(o)-s)}function tt(o,t,e,r,i){const s=t/2,n=i/e-o,a=Math.sqrt(t*t+e*e),d=(i+t*Math.sign(i))/e-o,c=Math.cos(n),h=Math.sin(n),l={x:(e+s)*c+r,y:(e+s)*h},y={x:(e-s)*c+r,y:(e-s)*h},v={x:a*Math.cos(d)+r,y:a*Math.sin(d)};return T(l,v,y)}function H(o,t,e,r,i){if(t<0)throw new Error(`Radius cannot be negative. Given: ${t}`);if(i<0)throw new Error(`The size of the arrowhead cannot be negative. Given: ${i}`);return t===1/0?C(e,o,r,i):Z(o,t,e,r)+tt(o,i,t,r,e)}function z(o,t,e,r,i){return H(o,t,t*e,r,i)}var et=Object.defineProperty,rt=Object.getOwnPropertyDescriptor,_=(o,t,e,r)=>{for(var i=r>1?void 0:r?rt(t,e):t,s=o.length-1,n;s>=0;s--)(n=o[s])&&(i=(r?n(t,e,i):n(i))||i);return r&&i&&et(t,e,i),i};function P(o,t,e){return Math.min(e,Math.max(o,t))}function it(o,t,e,r,i){return(o-t)*(i-r)/(e-t)+r}function ot(o){const t=o/2,e=`
    <line 
      x1="${-t}"
      y1="${-t}"
      x2="${t}"
  ...
  `,r=`
    <line 
      ...
      y2="${-t}"
    />
  `;return`<g class="x">${e} ${r}</g>`}class V extends U{constructor(){super(),this.leftMotorSpeed=0,this.rightMotorSpeed=0,new ResizeObserver(()=>{this.resized()}).observe(this)}get clampedLeftMotorSpeed(){return P(this.leftMotorSpeed,-1,1)}get clampedRightMotorSpeed(){return P(this.rightMotorSpeed,-1,1)}drawMotionVector(t,e){const r=this.renderRoot.querySelector("#svg").getBoundingClientRect(),i=r.width*.13,s=20,n=20,a=r.width-(i+s)*2,d=r.height-n*2;if(Math.abs(t)<=.05&&Math.abs(e)<=.05)return ot(r.width*.2);const c=Math.min(a,d)/2-8,h=8;if(Math.abs(t-e)<=.001)return`<g class="arrow">${C(Math.abs(t*c),-Math.sign(t)*Math.PI/2,0,h)}</g>`;const l=Math.PI,y=(e-t)/2,v=(t+e)/2,g=v/y;let M;if(Math.abs(g)>=1){const x=-Math.sign(g),$=(x+1)*l/2,m=Math.abs(g*c);M=H($,m,x*v*c,x*m,h)}else{const x=Math.sign(t-e);if(g===0){const $=Math.max(t,e)*c,m=x*l,R=y<0?l:0;M=z(R,$,m,0,h)}else{const $=g<0?t:e,m=g<0?e:t,R=Math.abs($)*c,G=-g*R,W=it(m/$,0,-1,.5,l),X=g<0?l:0;M=z(X,R,x*W,G,h)}}return`<g class="arrow">${M}</g>`}drawDrivetrain(){const t=this.renderRoot.querySelector("#svg").getBoundingClientRect(),e=t.width*.13,r=Math.min(t.width*.13,t.height*.15),i=20,s=20,n=`
      <rect 
  ...
  `;f([p({type:Number,attribute:"module-count"})],u.prototype,"moduleCount",2);f([p({type:Array,attribute:"wheel-locations"})],u.prototype,"wheelLocations",2);f([p({type:Array,attribute:"measured-states"})],u.prototype,"measuredStates",2);f([p({type:Array,attribute:"desired-states"})],u.prototype,"desiredStates",2);f([p({type:Number,attribute:"robot-rotation"})],u.prototype,"robotRotation",2);f([p({type:Number,attribute:"max-speed"})],u.prototype,"maxSpeed",2);f([p({type:String,attribute:"rotation-unit"})],u.prototype,"rotationUnit",2);f([p({type:Number,attribute:"size-left-right"})],u.prototype,"sizeLeftRight",2);f([p({type:Number,attribute:"size-front-back"})],u.prototype,"sizeFrontBack",2);f([F("svg")],u.prototype,"_svg",2);f([F(".swerve")],u.prototype,"_swerve",2);f([F(".base")],u.prototype,"_base",2);f([F(".modules")],u.prototype,"_modules",2);customElements.get("frc-swerve-drivebase")||customElements.define("frc-swerve-drivebase",u);
